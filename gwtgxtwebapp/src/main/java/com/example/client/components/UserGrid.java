...
public class UserGrid {
    ...
    public UserGrid() {
		...
		grid.getView().setForceFit(true);     // no horizontal scroll
		grid.setHeight(300);                  // fixed height
		grid.getView().setStripeRows(true);   // better UI
		grid.getView().setColumnLines(true);  // grid lines
    }
